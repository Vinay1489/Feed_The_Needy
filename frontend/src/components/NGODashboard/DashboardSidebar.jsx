...
function DashboardSidebar({
  ...
  const navItems = [
    ...
    { id: "map", label: "Food Rescue Map", icon: "map" },
    { id: "volunteers", label: "Volunteers", icon: "users" },
    { id: "donors", label: "Food Donors", icon: "store" },
    { id: "recipients", label: "Recipients", icon: "heart" },
    { id: "pickups", label: "Scheduled Pickups", icon: "calendar" },
    { id: "impact", label: "Impact Metrics", icon: "chart" },
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 bg-slate-800 text-white transition-all duration-300 z-10 ${
        collapsed ? "w-20" : "w-64"
      }`}
    >
      <div className="flex items-center justify-between h-16 px-4 border-b border-slate-700">
        <div className="flex items-center">
          ...
          {!collapsed && (
            <h1 className="ml-3 text-xl font-semibold">Food Rescue</h1>
          )}
        </div>
        <button
        ...
        >
          ...
          {!collapsed && (
            <div className="ml-3">
              ...
              <p className="text-xs text-slate-400">Accepting tasks</p>
            </div>
          )}
        </div>
      </div>
